...
│   │
│   ├── systems/                # 游戏系统
│   │   ├── CropSystem.ts       # 作物种植系统 (真实3D建模)
│   │   ├── BuildSystem.ts      # 建造系统
│   │   ├── InventorySystem.ts  # 背包/商店系统
│   │   ├── StorySystem.ts      # 剧情对话系统
│   │   ├── AchievementSystem.ts # 成就系统
│   │   ├── SoundSystem.ts      # 音效系统
│   │   ├── EcosystemSystem.ts  # 生态系统
│   │   ├── VoxelTerrain.ts     # 体素地形系统
│   │   ├── VoxelGameEngine.ts  # 体素游戏引擎
│   │   └── DataPersistence.ts  # 数据持久化
│   │
│   ├── entities/               # 游戏实体
...
#### 7. 剧情系统
- [x] NPC对话系统 (神秘老者/农夫/建筑师/异兽大师)
- [x] 5个主线任务
- [x] 剧情进度追踪

#### 8. 成就系统
- [x] 20+成就 (作物/建造/异兽/探索/收藏)
- [x] 游戏统计追踪
- [x] 成就解锁奖励
